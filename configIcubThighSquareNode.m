...
meshDesign.m         = 8;
meshDesign.baseIndex = 5;

meshDesign.linkDimension = meshDesign.diameter * tan(pi/meshDesign.m);
meshDesign.n = round(meshDesign.length/meshDesign.linkDimension);

meshDesign.fixedLinksIndexes = meshDesign.baseIndex : meshDesign.m : meshDesign.m*meshDesign.n;
meshDesign.tform_0_bBase = getTformGivenPosRotm([0 0 meshDesign.diameter/2]',createRotationMatrix(@rz,pi/2));

meshDesign.rzi_pj0_cj0 = 0;
meshDesign.rzj_pj0_cj0 = 2*pi/meshDesign.m;
