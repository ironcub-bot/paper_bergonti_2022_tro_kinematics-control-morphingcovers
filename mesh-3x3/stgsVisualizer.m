...
stgs.visualizer.limitMaximumTime = 8;
...
stgs.visualizer.mBody.bodyCSYS.dim        = linkDimension/2;
...
stgs.visualizer.joint.sphere.dimMin         = linkDimension/4;
...
stgs.visualizer.desiredShape.normal.dim        = linkDimension/3;
...
stgs.visualizer.gif.name             = ['3x3.gif'];
stgs.visualizer.gif.compressionRatio = 2;

stgs.visualizer.video.save    = 1;
stgs.visualizer.video.name    = ['3x3.mp4'];
