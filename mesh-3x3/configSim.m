...
stgs.integrator.limitMaximumTime = 8;
...
stgs.visualizer.mBody.bodyCSYS.dim        = model.linksAttributes{1}.linkDimension/2;
...
stgs.visualizer.joint.sphere.faceAlpha      = 1;
stgs.visualizer.joint.sphere.dimMin         = model.linksAttributes{1}.linkDimension/4;
...
stgs.visualizer.desiredShape.normal.dim        = model.linksAttributes{1}.linkDimension/3;
