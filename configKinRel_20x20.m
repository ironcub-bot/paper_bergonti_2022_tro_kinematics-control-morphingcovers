...
stgs.desiredShape.fun = @(x,y)   0.5*(x-0.46).^2-0.5*(y+0.46).^2;
stgs.desiredShape.fun = @(x,y,t) stgs.desiredShape.fun(x*cos(pi/4)-y*sin(pi/4),x*sin(pi/4)+y*cos(pi/4));
...
stgs.integrator.limitMaximumTime = 20;
